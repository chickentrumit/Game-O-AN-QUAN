...
public class GUI extends javax.swing.JFrame {
    ...
    public GUI() {
        initComponents(); //khoi tạo 
        setResizable(false); // đặt 
    ...
    void win() {
        ...
        if (xacDinhThangThua == 0) {
            JOptionPane.showMessageDialog(null, "Hoà", "Thông báo", 1);
        }
        String xdNguoiChoi = "";
        ...
        JOptionPane.showMessageDialog(null, xdNguoiChoi + " đã thắng", "Thông báo", 1);
    }
